...
| Languages | Level |
|:---|:---|
| C++ | [Advanced]{style="color:green;"} |
| Matlab | [Advanced]{style="color:green;"} |
| Maple | [Intermediate]{style="color:var(--primary-color);"} |
| Mathematica | [Intermediate]{style="color:var(--primary-color);"} |
| Python | [Intermediate]{style="color:var(--primary-color);"} |
| Ruby | [Base]{style="color:var(--secondary-color);"} |
| Simulink | [Base]{style="color:var(--secondary-color);"} |

: First Table {#tbl-first}

| Tools | Level |
|:---|:---|
| git/GitHub | [Advanced]{style="color:green;"} |
| LaTeX/QMD | [Advanced]{style="color:green;"} |
| PINS | [Advanced]{style="color:green;"} |
| cmake/make | [Intermediate]{style="color:var(--primary-color);"} |
| Carmaker | [Intermediate]{style="color:var(--primary-color);"} |
| RTMaps | [Base]{style="color:var(--secondary-color);"} |
| CasADi | [Base]{style="color:var(--secondary-color);"} |

: Second Table {#tbl-second}

| Additional | Level |
|:---|:---|
| UniTN bureaucracy | [Black belt]{style="color:green;"} |
| F1TENT | [Minimal experience]{style="color:var(--secondary-color);"} |
| ROS2 | [Minimal experience]{style="color:var(--secondary-color);"} |

: Third Table {#tbl-third}
...
<div id="contentframe" style="position:relative; left: 10%; width: 80%; height: 80%">
{{< video https://www.youtube.com/embed/WEdmq2CjoQ4?rel=0  width="100%" height="100%" controls muted autoplay loop>}}
</div>
